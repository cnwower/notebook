...
var outer = {
    "case0": {
        "case0_0": {
            "title": "说明",
            "content": "1. 支持笔记本的新建、双击改名及删除；<br>" + " 2. 支持笔记的新建、内容保存/修改及删除（按Delete键或清空内容及标题后切换笔记）；<br>" + "3. 内容保存时检测是否存在笔记本或笔记；<br>" + "4. 单击右下‘保存’图标或切换笔记可保存当前笔记内容；<br>" + "5. 支持涂鸦及保存；<br>"+ "6. 单击内容右下‘箭头’图标展开Markdown语法解析窗口。"
        },
        "case0_1": {
            "title": "Markdown语法解析",
